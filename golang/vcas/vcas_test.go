...
func init() {
	...
	fmt.Println("Location Name:", time.Local.String())
	fmt.Println("Is DST:", time.Now().IsDST())
}
	...
	cases := map[string]struct {
		...
		`with float`: {
			...
			exp: struct {
				...
				err: false,
				res: "time:11.06.2005 23_59_59.999|method:set|name:test|val:11.06\n",
			},
		},
		`with string`: {
			inp: Packet{
			...
			exp: struct {
				...
				err: false,
				res: "time:11.06.2005 23_59_59.999|method:set|name:test|val:hello\n",
			},
		},
		`without value`: {
			inp: Packet{
			...
			exp: struct {
				...
				err: false,
				res: "time:11.06.2005 23_59_59.999|method:set|name:test|val:none\n",
			},
		},
		`without name`: {
			inp: Packet{
...
func BenchmarkMarshal(b *testing.B) {
	for b.Loop() {
		...
		pkt := Packet{
			...
			Time:   time.UnixMilli(1118505599999).Local(),
			Value:  rand.Float64(),
		}
...
func TestUnmarshal(t *testing.T) {
	cases := map[string]struct {
		...
		`publish (s)`: {
			inp: "time:11.06.2005 23_59_59.999|method:s|name:test|val:11.06",
			exp: struct {
				err bool
				res Packet
			}{
		...
		`time (t)`: {
			inp: "t:11.06.2005 23_59_59.999|method:set|name:test|val:11.06",
			exp: struct {
				err bool
				res Packet
			}{
		...
		`method (meth)`: {
			inp: "time:11.06.2005 23_59_59.999|meth:set|name:test|val:11.06",
			exp: struct {
				err bool
				res Packet
			}{
		...
		`method (m)`: {
			inp: "time:11.06.2005 23_59_59.999|m:set|name:test|val:11.06",
			exp: struct {
				err bool
				res Packet
			}{
		...
		`name (n)`: {
			inp: "time:11.06.2005 23_59_59.999|method:set|n:test|val:11.06",
			exp: struct {
				err bool
				res Packet
			}{
		...
		`with extra token`: {
			inp: "time:11.06.2005 23_59_59.999|extra:none|method:set|name:test|val:11.06",
			exp: struct {
				err bool
				res Packet
			}{
		...
		`with none value`: {
			inp: "time:11.06.2005 23_59_59.999|method:set|name:test|val:none",
			exp: struct {
				err bool
				res Packet
			}{
		...
		`with malformed time`: {
			inp: "time:11.06.2005 23:59:59.999|method:set|name:test|val:11.06",
			exp: struct {
				err bool
				res Packet
			}{
		...
		`without name`: {
			inp: "time:11.06.2005 23_59_59.999|method:set|val:11.06",
			exp: struct {
				err bool
				res Packet
			}{
		...
		`without method`: {
			inp: "time:11.06.2005 23_59_59.999|name:test|val:11.06",
			exp: struct {
				err bool
				res Packet
			}{
...
func BenchmarkUnmarshal(b *testing.B) {
	for b.Loop() {
		...
		pkt := Packet{}
		pay := fmt.Appendf(nil,
			"time:11.06.2005 23_59_59.999|method:subscribe|name:VEPP/CCD/1M1L/sigma_x|val:%f",
			rand.Float64(),
		)
